    ...
    "paths": {
        ...
        "/api/feedbacks/upload": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message=File processed successfully, total=number of feedbacks, success_count=number of successfully processed feedbacks, error_count=number of failed feedbacks, errors=list of errors",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
